...
-- Question 13 : What are the top 5 states with the highest & lowest average delivery time?
WITH Avg_DeliveryTime_Table as
(SELECT
customer_state,
round(AVG(DATEDIFF(order_delivered_customer_date, order_purchase_timestamp)),2) as Avg_DeliveryTime
